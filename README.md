...
<h3> После завершения в папке results/ появятся:
 -output.mp4 — видео с визуализацией состояний столика
  -events.csv — таблица событий
   -report.txt — краткий текстовый отчёт со средним временем задержки.
